...
def clipping_KNN():
    ...
    for i in range(0,groupnum):
        ...
        trainData_i = np.setdiff1d(trainData,trainLabel_cut)
        dists = euclideanDistance_two_loops(trainData_i, trainData_cut)
        ...
        New_traindata.append(trainLabel_cut)
...
if __name__ == "__main__":
    ...
    for i in range(0,groupnum):
        ...
        print(deletelist)
        trainLabel_cut = np.delete(trainLabel_cut,deletelist,axis=0)
        for n in range(len(trainLabel_cut)):
            New_traindata.append(trainLabel_cut[n])
    print(New_traindata)
